...
export interface FileRouteTypes { fileRoutesByFullPath: FileRoutesByFullPath; fullPaths: '/'; fileRoutesByTo: FileRoutesByTo; to: '/'; id: '__root__' | '/'; fileRoutesById: FileRoutesById }
